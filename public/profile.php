...
<head>
	...
	<title>プロフィール - ゆきフォリオ (YUKINO Portfolio)</title>
    ...
    <link rel="stylesheet" href="./css/main_profile.css?<?= time(); ?>">
...
<?
require_once "page/profile.phtml";
?>
            </section>
        </main>
    ...
    <script defer src="./js/p_profile.js?<?= time(); ?>"></script>
